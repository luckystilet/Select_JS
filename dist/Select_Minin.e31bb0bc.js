...
var _prettyData = new WeakSet();

var Select = /*#__PURE__*/function () {
  function Select(selector, options) {
    _classCallCheck(this, Select);

    _prettyData.add(this);
    ...
    this.data = _classPrivateMethodGet(this, _prettyData, _prettyData2).call(this, options.data);
  ...
  _createClass(Select, [{
    ...
    value: function select(id) {
      ...
      this.$el.querySelector("[data-id=\"".concat(id, "\"]")).classList.add('active');
...
var _render2 = function _render2() {
  var _this$options = this.options,
      ...
      selected = _this$options.selected;
...
var _prettyData2 = function _prettyData2(arr) {
...
window.s = select; // const arr = ['a','b','v','g','d',]
...
//# sourceMappingURL=/Select_Minin.e31bb0bc.js.map